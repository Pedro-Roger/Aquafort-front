      ...
      >
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.15fr) minmax(0, 0.95fr)', gap: 16, alignItems: 'start' }}>
          <div style={{ minWidth: 0 }}>
            <div style={{ fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.12em', opacity: 0.72 }}>Biometrias</div>
            <h1 style={{ margin: '8px 0 0', fontSize: 30, lineHeight: 1.05, letterSpacing: '-0.05em' }}>Crescimento, sobrevivência e dieta em um lugar só.</h1>
            <p style={{ marginTop: 10, color: 'rgba(238,251,248,0.78)', maxWidth: 760 }}>
              Registre a leitura, acompanhe a curva e volte rápido para a decisão operacional.
            </p>
          </div>
          <CycleWorkspacePanel
            eyebrow="Ciclo ativo"
